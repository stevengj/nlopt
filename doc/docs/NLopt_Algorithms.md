...
AGS is specified within NLopt by `NLOPT_AGS`. Additional parameters of AGS which are not adjustable from the common NLOpt interface are declared and described in `ags.h`.
References:
